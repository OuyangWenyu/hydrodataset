...
class waterbenchiowa(HydroDataset):
    """WaterBenchIowa dataset class extending RainfallRunoff.

    This class provides access to the WaterBenchIowa dataset, which contains hourly
    ...
    def __init__(self, data_path, region=None, download=False):
        """Initialize WaterBenchIowa dataset.

        Args:
            data_path: Path to the WaterBenchIowa data directory
        ...
        self.aqua_fetch = WaterBenchIowa(data_path)

    @property
    def _attributes_cache_filename(self):
        return "waterbenchiowa_attributes.nc"

    @property
    def _timeseries_cache_filename(self):
        return "waterbenchiowa_timeseries.nc"

    @property
    def default_t_range(self):
        return ["20111001 12:00:00", "20180930 11:00:00"]
