...
class CamelsInd(HydroDataset):
    """CAMELS_IND dataset class extending RainfallRunoff.

    This class provides access to the CAMELS_IND dataset, which contains hourly
    ...
    def __init__(self, data_path, region=None, download=False):
        ...
        """
        # Call parent class RainfallRunoff constructor with CAMELS_IND dataset
    ...
    def cache_attributes_xrdataset(self):
        ...
        ds_attr.to_netcdf(CACHE_DIR.joinpath("camels_ind_attributes.nc"))
        return
    ...
    def cache_timeseries_xrdataset(self):
        ...
        # 保存文件
        batch_filename = f"camels_ind_timeseries.nc"
    ...
    def read_attr_xrdataset(self, gage_id_lst=None, var_lst=None, **kwargs):
        ...
        try:
            attr = xr.open_dataset(CACHE_DIR.joinpath("camels_ind_attributes.nc"))
    ...
    def read_ts_xrdataset(
        ...
        **kwargs,
        ...
        camels_ind_tsnc = CACHE_DIR.joinpath("camels_ind_timeseries.nc")
        if not os.path.isfile(camels_ind_tsnc):
            self.cache_timeseries_xrdataset()
        ts = xr.open_dataset(camels_ind_tsnc)
