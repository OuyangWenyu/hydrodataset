...
CAMELS_REGIONS = ["AUS", "BR", "CCAM", "CH", "CL", "DE", "DK", "FR", "GB", "IND", "SE", "US", "AUS_v2", "YSTL"]
LAMAH_REGIONS = ["CE"]
...
from .camels import *
from .camels_aus import *
from .camels_br import *
from .camels_ccam import *
from .camels_ch import *
from .camels_cl import *
