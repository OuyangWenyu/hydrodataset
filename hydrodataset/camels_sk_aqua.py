...
class CamelsSk(HydroDataset):
    ...
    def __init__(self, data_path, region=None, download=False):
        ...
        """
        # Call parent class RainfallRunoff constructor with CAMELS_SK dataset
    ...
    def cache_attributes_xrdataset(self):
        ...
        ds_attr.to_netcdf(CACHE_DIR.joinpath("camels_sk_attributes.nc"))
        return
    ...
    def cache_timeseries_xrdataset(self):
        ...
        # 保存文件
        batch_filename = f"camels_sk_timeseries.nc"
    ...
    def read_ts_xrdataset(
        ...
        **kwargs,
        ...
        if t_range is None:
            t_range = ["2000-01-01", "2019-12-31 23:59:59"]
        camels_sk_tsnc = CACHE_DIR.joinpath("camels_sk_timeseries.nc")
        if not os.path.isfile(camels_sk_tsnc):
            self.cache_timeseries_xrdataset()
        ts = xr.open_dataset(camels_sk_tsnc)
