...
class CamelsDK(HydroDataset):
    ...
    def __init__(self, data_path, region=None, download=False):
        ...
        """
        # Call parent class RainfallRunoff constructor with CAMELS_DK dataset
    ...
    def cache_attributes_xrdataset(self):
        ...
        ds_attr.to_netcdf(CACHE_DIR.joinpath("camels_dk_attributes.nc"))
        return
    ...
    def cache_timeseries_xrdataset(self):
        ...
        batch_data = self.aqua_fetch.fetch_stations_features(
            ...
            st='1989-01-02 00:00:00',
            en='2023-12-31 00:00:00',
            as_dataframe=False,
        )
        ...
        # 保存文件
        batch_filename = f"camels_dk_timeseries.nc"
    ...
    def read_attr_xrdataset(self, gage_id_lst=None, var_lst=None, **kwargs):
        ...
        try:
            attr = xr.open_dataset(CACHE_DIR.joinpath("camels_dk_attributes.nc"))
    ...
    def read_ts_xrdataset(
        ...
        **kwargs,
        ...
        if t_range is None:
            t_range = ["1989-01-02 00:00:00", "2023-12-31 00:00:00"]
        camels_dk_tsnc = CACHE_DIR.joinpath("camels_dk_timeseries.nc")
        if not os.path.isfile(camels_dk_tsnc):
            self.cache_timeseries_xrdataset()
        ts = xr.open_dataset(camels_dk_tsnc)
