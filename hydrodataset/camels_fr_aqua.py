...
class CamelsFr(HydroDataset):
    ...
    def __init__(self, data_path, region=None, download=False):
        ...
        """
        # Call parent class RainfallRunoff constructor with CAMELS_FR dataset
    ...
    def cache_attributes_xrdataset(self):
        ...
        ds_attr.to_netcdf(CACHE_DIR.joinpath("camels_fr_attributes.nc"))
        return
    ...
    def cache_timeseries_xrdataset(self):
        ...
        # 保存文件
        batch_filename = f"camels_fr_timeseries.nc"
    ...
    def read_attr_xrdataset(self, gage_id_lst=None, var_lst=None, **kwargs):
        ...
        try:
            attr = xr.open_dataset(CACHE_DIR.joinpath("camels_fr_attributes.nc"))
    ...
    def read_ts_xrdataset(
        ...
        **kwargs,
        ...
        camels_fr_tsnc = CACHE_DIR.joinpath("camels_fr_timeseries.nc")
        if not os.path.isfile(camels_fr_tsnc):
            self.cache_timeseries_xrdataset()
        ts = xr.open_dataset(camels_fr_tsnc)
