from aqua_fetch import CAMELS_ES
from hydrodataset import HydroDataset


class CamelsEs(HydroDataset):
    """CamelsEs dataset class extending RainfallRunoff.

    This class provides access to the CamelsEs dataset, which contains hourly
    ...
    def _attributes_cache_filename(self):
        return "camels_es_attributes.nc"

    @property
    def _timeseries_cache_filename(self):
        return "camels_es_timeseries.nc"
