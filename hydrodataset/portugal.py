...
class portugal(HydroDataset):
    """portugal dataset class extending RainfallRunoff.

    This class provides access to the portugal dataset, which contains hourly
    ...
    def __init__(self, data_path, region=None, download=False):
        """Initialize portugal dataset.

        Args:
            data_path: Path to the portugal data directory
        ...
        self.aqua_fetch = Portugal(data_path)

    @property
    def _attributes_cache_filename(self):
        return "portugal_attributes.nc"

    @property
    def _timeseries_cache_filename(self):
        return "portugal_timeseries.nc"

    @property
    def default_t_range(self):
        return ["1972-01-01", "2022-12-31"]
