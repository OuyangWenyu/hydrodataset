...
class Italy(HydroDataset):
    """Italy dataset class extending RainfallRunoff.

    This class provides access to the Italy dataset, which contains hourly
    ...
    def __init__(self, data_path, region=None, download=False):
        """Initialize Italy dataset.

        Args:
            data_path: Path to the Italy data directory
        ...
        self.aqua_fetch = Italy(data_path)

    @property
    def _attributes_cache_filename(self):
        return "italy_attributes.nc"

    @property
    def _timeseries_cache_filename(self):
        return "italy_timeseries.nc"
