...
class IreLand(HydroDataset):
    """Ireland dataset class extending RainfallRunoff.

    This class provides access to the Ireland dataset, which contains hourly
    ...
    def __init__(self, data_path, region=None, download=False):
        """Initialize Ireland dataset.

        Args:
            data_path: Path to the Ireland data directory
        ...
        self.aqua_fetch = Ireland(data_path)

    @property
    def _attributes_cache_filename(self):
        return "ireland_attributes.nc"

    @property
    def _timeseries_cache_filename(self):
        return "ireland_timeseries.nc"
