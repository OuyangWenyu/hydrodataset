...
class CamelsDe(Camels):
    ...
    def cache_attributes_xrdataset(self):
        ...
        attr_files = self.data_source_dir.glob("CAMELS_DE_*.csv")
        attrs = {
        ...
        units_dict = {
            ...
            "coarse_fragments_0_30cm_mean": "cm^3/100cm^3(vol%)",
            "coarse_fragments_30_100cm_mean": "cm^3/100cm^3(vol%)",
            "coarse_fragments_100_200cm_mean": "cm^3/100cm^3(vol%)",
