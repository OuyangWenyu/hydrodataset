from aqua_fetch import JialingRiverChina
from hydrodataset import HydroDataset


class jialingriverchina(HydroDataset):
    """JialingRiverChina dataset class extending RainfallRunoff.

    This class provides access to the JialingRiverChina dataset, which contains hourly
    ...
    def __init__(self, data_path, region=None, download=False):
        """Initialize JialingRiverChina dataset.

        Args:
            data_path: Path to the JialingRiverChina data directory
        ...
        self.aqua_fetch = JialingRiverChina(data_path)

    @property
    def _attributes_cache_filename(self):
        return "JialingRiverChina_attributes.nc"

    @property
    def _timeseries_cache_filename(self):
        return "JialingRiverChina_timeseries.nc"
