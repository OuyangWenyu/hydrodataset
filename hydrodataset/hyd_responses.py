from aqua_fetch import HYD_RESPONSES
from hydrodataset import HydroDataset


class HydResponses(HydroDataset):
    """HYD_RESPONSES dataset class extending RainfallRunoff.

    This class provides access to the HYD_RESPONSES dataset, which contains hourly
    ...
    def __init__(self, data_path, region=None, download=False):
        """Initialize HYD_RESPONSES dataset.

        Args:
            data_path: Path to the HYD_RESPONSES data directory
        ...
        self.aqua_fetch = HYD_RESPONSES(data_path)

    @property
    def _attributes_cache_filename(self):
        return "hyd_responses_attributes.nc"

    @property
    def _timeseries_cache_filename(self):
        return "hyd_responses_timeseries.nc"

    @property
    def default_t_range(self):
        return ["1909-01-01", "2024-05-31"]
