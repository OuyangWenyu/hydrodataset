...
class CamelsLux(HydroDataset):
    ...
    def __init__(self, data_path, region=None, download=False):
        ...
        """
        # Call parent class RainfallRunoff constructor with CAMELS_LUX dataset
    ...
    def cache_attributes_xrdataset(self):
        ...
        ds_attr.to_netcdf(CACHE_DIR.joinpath("camels_lux_attributes.nc"))
        return
    ...
    def cache_timeseries_xrdataset(self):
        ...
        # 保存文件
        batch_filename = f"camels_lux_timeseries.nc"
    ...
    def read_attr_xrdataset(self, gage_id_lst=None, var_lst=None, **kwargs):
        ...
        try:
            attr = xr.open_dataset(CACHE_DIR.joinpath("camels_lux_attributes.nc"))
    ...
    def read_ts_xrdataset(
        ...
        **kwargs,
        ...
        if t_range is None:
            t_range = ["2004-01-01", "2021-12-31"]
        camels_lux_tsnc = CACHE_DIR.joinpath("camels_lux_timeseries.nc")
        if not os.path.isfile(camels_lux_tsnc):
            self.cache_timeseries_xrdataset()
        ts = xr.open_dataset(camels_lux_tsnc)
