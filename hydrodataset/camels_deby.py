from aqua_fetch import CAMELS_DEBY
from hydrodataset import HydroDataset


class CamelsDeby(HydroDataset):
    """Camels_Deby dataset class extending RainfallRunoff.

    This class provides access to the Camels_Deby dataset, which contains hourly
    ...
    def __init__(self, data_path, region=None, download=False):
        """Initialize Camels_Deby dataset.

        Args:
            data_path: Path to the Camels_Deby data directory
        ...
        self.aqua_fetch = CAMELS_DEBY(data_path)

    @property
    def _attributes_cache_filename(self):
        return "camels_deby_attributes.nc"

    @property
    def _timeseries_cache_filename(self):
        return "camels_deby_timeseries.nc"

    @property
    def default_t_range(self):
        return ["2007-01-01", "2023-12-30"]
