...
def test_download_camels(camels_us_path):
    ...
    assert os.path.isfile(os.path.join(camels_us_path, "basin_set_full_res", "HCDN_nhru_final_671.shp"))
...
def test_download_camels_aus(camels_aus_path):
    ...
    assert os.path.isfile(os.path.join(camels_aus_path, "05_hydrometeorology", "05_hydrometeorology",
...
def test_download_camels_br(camels_br_path):
    ...
    assert os.path.isfile(os.path.join(camels_br_path, "01_CAMELS_BR_attributes", "01_CAMELS_BR_attributes",
...
def test_download_camels_cl(camels_cl_path):
    ...
    assert os.path.isfile(os.path.join(camels_cl_path, "1_CAMELScl_attributes", "1_CAMELScl_attributes.txt"))
...
def test_download_camels_gb(camels_gb_path, gb_region):
    ...
    assert os.path.isfile(os.path.join(camels_gb_path, "8344e4f3-d2ea-44f5-8afa-86d2987543a9",
...
def test_download_camels_yr(camels_yr_path, yr_region):
    ...
    assert os.path.isfile(
        os.path.join(camels_yr_path, "9_Normal_Camels_YR", "1_Normal_Camels_YR_basin_data", "0146", "attributes.json"))
...
def test_download_canopex(canopex_path, ca_region):
    ...
    assert os.path.isfile(os.path.join(canopex_path, "CANOPEX_NRCAN_ASCII", "CANOPEX_NRCAN_ASCII", "1.dly"))
...
def test_download_lamah_ce(lamah_ce_path, lamah_ce_region):
    ...
    assert os.path.isfile(
        os.path.join(lamah_ce_path, "2_LamaH-CE_daily", "A_basins_total_upstrm", "2_timeseries", "daily", "ID_882.csv"))
