...
**CAMELS-FR** is the France hydrological dataset implementation. French CAMELS dataset for diverse catchments across France.
...
# Initialize dataset
data_path = resolve_data_path("camels_fr")
...
::: hydrodataset.camels_fr.CamelsFr
    options:
