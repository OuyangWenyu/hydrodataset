...
**CAMELS-DK** is the Denmark hydrological dataset implementation. Danish CAMELS dataset for catchments in Denmark.
...
# Initialize dataset
data_path = resolve_data_path("camels_dk")
...
::: hydrodataset.camels_dk.CamelsDk
    options:
