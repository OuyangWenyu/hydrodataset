...
**CAMELS-LUX** is the Luxembourg hydrological dataset implementation. Luxembourg CAMELS dataset for small European catchments.
...
# Initialize dataset
data_path = resolve_data_path("camels_lux")
...
::: hydrodataset.camels_lux.CamelsLux
    options:
