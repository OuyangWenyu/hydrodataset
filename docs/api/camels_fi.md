...
**CAMELS-FI** is the Finland hydrological dataset implementation. Finnish CAMELS dataset covering boreal climate catchments.
...
# Initialize dataset
data_path = resolve_data_path("camels_fi")
...
::: hydrodataset.camels_fi.CamelsFi
    options:
